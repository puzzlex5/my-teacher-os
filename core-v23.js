(function(root,factory){const api=factory();if(typeof module==='object'&&module.exports)module.exports=api;else root.TeacherOSDocAI=api})(typeof globalThis!=='undefined'?globalThis:this,function(){
  ...
  function compatibility(docClass,kind,mixed=false){if(kind==='profile')return 1;if(mixed||docClass==='schoolplan')return .9;if(docClass==='calendar')return kind==='calendar'?1:.28;if(docClass==='timetable')return kind==='timetable'?1:(kind==='live'?.65:.25);if(docClass==='live')return kind==='live'?1:(kind==='timetable'?.75:.25);if(docClass==='assessment')return kind==='assessment'?1:(kind==='calendar'?.45:.22);if(docClass==='admin')return kind==='admin'?1:(kind==='calendar'?.42:.24);if(docClass==='club')return kind==='calendar'?.9:(kind==='admin'?.45:.25);if(docClass==='student')return .08;return .55}

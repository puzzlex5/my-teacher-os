(function(){
  ...
  function validState22(obj){return !!obj&&typeof obj==='object'&&!Array.isArray(obj)&&!!obj.years&&typeof obj.years==='object'&&!Array.isArray(obj.years)&&Object.values(obj.years).every(y=>!!y&&typeof y==='object'&&!Array.isArray(y))&&((obj.currentYear===null||obj.currentYear===undefined||obj.currentYear==='')||Object.prototype.hasOwnProperty.call(obj.years,String(obj.currentYear)))}
  function openDB(){
  ...
  function currentStateJSON(){const raw=localStorage.getItem(DATA_KEY);if(!raw)throw new Error('저장된 Teacher OS 데이터가 없습니다.');const obj=JSON.parse(raw);if(!validState22(obj))throw new Error('현재 Teacher OS 데이터 형식이 올바르지 않습니다.');return JSON.stringify(obj)}

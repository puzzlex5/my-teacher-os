...
for(const bad of [null,[],{},{years:[]},{years:{2026:null}},{years:{2026:[]}},{years:{2026:'broken'}}]){
...
console.log('v0.22 local recovery snapshot tests passed with shared-storage and nested malformed-state guards');
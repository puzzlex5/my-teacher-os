...
console.log('v0.25 grounded school-record quality tests passed with strict sentence, Korean particle, stale-evidence, direct-PII, and stale-snapshot checks');

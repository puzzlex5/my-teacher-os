...
// Collector must refresh through the day and expose only sanitized health categories.
...
assert.ok(sync.includes('teacher-resolution'),'v1 lost safe teacher-resolution failure classification');
